...
class ServicioEfectuadoController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('primary.servicios_efectuados.servicios_efectuados_update', compact('servicioEfectuado', 'clientes', 'servicios', 'promos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Actualizar los datos del servicio efectuado
        $servicioEfectuado->cliente_id = $request->cliente_id;
        $servicioEfectuado->servicio_id = $request->servicio_id;
        $servicioEfectuado->promo_id = $request->promo_id;
        $servicioEfectuado->libras = $request->libras;
        $servicioEfectuado->notas = $request->notas;
        $servicioEfectuado->estado = $request->estado; // Actualizar el estado
        $servicioEfectuado->envio = $request->envio;
        $servicioEfectuado->direccion = $request->direccion; // Actualizar la dirección
        $servicioEfectuado->precio_envio = $request->precio_envio; // Actualizar el precio de envío
        $servicioEfectuado->pago_envio = $request->pago_envio; // Actualizar quién paga el envío
        $servicioEfectuado->total = str_replace(',', '', $request->total); // Eliminar las comas y actualizar el total
        $servicioEfectuado->save();

        return redirect()->route('servicios_efectuados.index')->with('success', 'El servicio efectuado ha sido actualizado exitosamente.');
    }
