...
// Ruta para generar una constancia PDF del empleado
...
// Ruta para generar un pdf de la lista de control de cuentas
    Route::get('/control-cuentas/export-pdf', [ControlCuentaController::class, 'exportPDF'])->name('control-cuentas.export-pdf');
