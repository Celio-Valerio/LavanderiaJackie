                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="form-control-static">{{ $maquinaria->name }}</p>
                            </div>

                            <!-- Marca -->
                            <div class="col-md-6">
                                <label for="brand" class="form-label"><strong>Marca</strong></label>
                                <p class="form-control-static">{{ $maquinaria->brand }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="form-control-static">{{ $maquinaria->model }}</p>
                            </div>

                            <!-- Fecha de adquisición -->
                            <div class="col-md-4">
                                <label class="form-label"><strong>Fecha de Adquisición:</strong></label>
                                <p>{{ \Carbon\Carbon::parse($maquinaria->acquisition_date)->translatedFormat('l d \d\e F, Y') }}</p>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="form-control-static">{{ $maquinaria->type }}</p>
                            </div>

                            <!-- Estado de la maquinaria -->
                            <div class="col-md-6">
                                <label for="status" class="form-label"><strong>Estado</strong></label>
                                <p class="form-control-static">{{ $maquinaria->status }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="form-control-static">{{ $maquinaria->proveedor->full_name }}</p>
                            </div>
                        </div>
