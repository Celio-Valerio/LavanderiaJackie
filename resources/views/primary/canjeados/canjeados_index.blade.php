...
@section('title', 'Lista de cupones canjeados')
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h1 class="card-title" style="font-size: 30px; margin: 0;">Lista de cupones canjeados</h1>
                        ...
                        <table id="cuponesTable" class="table table-striped table-bordered" style="padding-top: 20px; padding-bottom: 10px; text-align: center;">
                            ...
                            @forelse($cupones as $cupon)
                                @php
                                    $clientes = $cupon->clientes;
                                    $canjeado = false;
                                @endphp
                                @if($clientes->isNotEmpty())
                                    @foreach($clientes as $cliente)
                                        @if($cliente->pivot->canjeado != 1)
                                            @php
                                                $canjeado = false;
                                                break;
                                            @endphp
                                ...
                                @if($canjeado == true)
                                    <tr data-fecha="{{ \Carbon\Carbon::parse($cupon->fecha_desde)->format('Y-m-d') }}">
                                        ...
                                        <td class="small-text-field">
                                            <span class="badge bg-warning">Canjeado</span>
                                        </td>
