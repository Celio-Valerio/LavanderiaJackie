    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="card-title" style="font-size: 30px !important;">Editar usuario</h1>
                        <hr>
                        <form id="usuarioForm" action="{{ route('usuarios.update', $usuario) }}" method="POST" novalidate enctype="multipart/form-data">@csrf
                            @method('PUT')
