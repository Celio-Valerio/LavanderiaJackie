...
<section class="section">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('compras.store') }}" method="POST" novalidate id="compraForm">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div id="linea" class="col-mb-12 bg-primary" style="height: 3px; margin-bottom: 20px"></div>
    ...
    <script>
        ...
        function cargarProductos() {
            ...
            @foreach($productos as $producto)
                selectProductos.innerHTML += '<option value="{{$producto->id}}">{{$producto->nombre}}</option>';
            @endforeach
        }
