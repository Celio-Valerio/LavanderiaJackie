    ...
    <div class="invoice-container">
            ...
            <table style="width: 100%; border-bottom: 2px solid #333; margin-bottom: 10px;">
                <tr>
                    ...
                    <td style="text-align: center; font-size: 12px; line-height: 1.3;">
                        ...
                        Reporte de Gastos Generales<br>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="text-end">Gastos productos</th>
            ...
            @foreach($gastos as $i => $gasto)
                <tr>
                    ...
                    <td class="text-end">L. {{ number_format($gasto->totalG, 2, '.', ',') }}</td>
                    <td class="text-end">L. {{ number_format($gasto->totalP, 2, '.', ',') }}</td>
                    <td class="text-end">
                        L. {{ number_format($gasto->totalG + $gasto->totalP, 2, '.', ',') }}
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            <tr class="total-row">
                ...
                <td class="text-end">L. {{ number_format($totalGastosFijos, 2, '.', ',') }}</td>
                <td class="text-end">L. {{ number_format($totalGastosProductos, 2, '.', ',') }}</td>
                <td class="text-end">
                    L. {{ number_format($totalGastosFijos + $totalGastosProductos, 2, '.', ',') }}
                </td>
            </tr>
            </tfoot>
        </table>
