...
@section('content')
    ...
    <div class="invoice-container">
        ...
        <div class="title">
            <strong style="font-size: 18px;">Reporte de servicios efectuados</strong><br>
            <div style="font-size: 14px;">Generado el: {{ \Carbon\Carbon::parse(now())->locale('es_ES')->isoFormat('D [de] MMMM YYYY') }}
            </div></div>
