...
@section('title', 'Detalles del Servicio Efectuado')
@section('content')
    ...
    <section class="section">
        @if($usuario->rolpermiso->serviciosefectuados_ver == 1)
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card shadow-lg rounded-lg border-0">
                        <div class="card-body">
                            <!-- Título de la sección -->
                            <h1 class="card-title text-center mb-4">Detalles del servicio efectuado</h1>
                            <hr>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <a href="{{ route('servicios_efectuados.index') }}" class="btn btn-secondary w-100 rounded-pill py-2">
                                        Volver a la Lista
                                    </a>
                                </div>
                            </div>
