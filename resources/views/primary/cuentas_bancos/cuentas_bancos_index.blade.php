                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="button-group d-flex gap-2">
                                <a href="{{ route('cuenta_bancos.create') }}" class="btn btn-primary btn-sm d-flex align-items-center" style="border-radius: 5px; height: 40px; padding: 0 15px">Registrar Transacción</a>
                            </div>
                        </div>
